                ...
                <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                        ...
                        <Button
                            variant="contained"
                            color="inherit"
                            onClick={() => navigate('/admin/archived-customers')}
                            ...
                            />
                                        ...
                                        <TableCell>
                                            <Stack direction="row" spacing={1}>
                                                <IconButton
                                                    onClick={() => navigate(`/admin/customer-info/${customer.customer_id}`)}
                                                    color="info"
                                                    title="View Details"
                                                >
                                                    <VisibilityIcon />
                                                ...
                                                <IconButton
                                                    onClick={() => navigate(`/admin/customer-info/${customer.customer_id}/edit-details`)}
                                                    color="primary"
                                                    title="Edit Customer"
                                                >
                                                    <EditIcon />
